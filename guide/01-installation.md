...
<div class="admonition note">
    <span class="title">
        <b>Заметка:</b> Не стоит путать IDE с редактором кода.
    </span>
    <p>
        <b>IDE</b> (Integrated development environment) - комплекс программных средств, используемый для разработки программного обеспечения, специализированный обычно под один или несколько языков программирования.
    </p>
    <p>
